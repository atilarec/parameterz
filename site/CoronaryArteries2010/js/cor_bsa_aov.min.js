...
function Cor_a(a) { this.a1 = a.a1; this.b1 = a.b1; this.sd = a.sd } Cor_a.prototype.mean = function() { return this.a1 + this.b1 * aov }; Cor_a.prototype.zscore = function(a) { return (a - this.mean(aov)) / this.sd }; Cor_a.prototype.limit = function(a) { return a * this.sd + this.mean(aov) };
